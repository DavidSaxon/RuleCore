...
void main()
{
    ...
    finalColour += texture2D( u_texture,
                   ...
                   FILTER_OFFSET_8;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 9.0 * pixelSize ) ) *
                   FILTER_OFFSET_9;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 10.0 * pixelSize ) ) *
                   FILTER_OFFSET_10;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 11.0 * pixelSize ) ) *
                   FILTER_OFFSET_11;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 12.0 * pixelSize ) ) *
                   FILTER_OFFSET_12;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 13.0 * pixelSize ) ) *
                   FILTER_OFFSET_13;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 14.0 * pixelSize ) ) *
                   FILTER_OFFSET_14;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 15.0 * pixelSize ) ) *
                   FILTER_OFFSET_15;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 16.0 * pixelSize ) ) *
                   FILTER_OFFSET_16;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 17.0 * pixelSize ) ) *
                   FILTER_OFFSET_17;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 18.0 * pixelSize ) ) *
                   FILTER_OFFSET_18;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 19.0 * pixelSize ) ) *
                   FILTER_OFFSET_19;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 20.0 * pixelSize ) ) *
                   FILTER_OFFSET_20;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 21.0 * pixelSize ) ) *
                   FILTER_OFFSET_21;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 22.0 * pixelSize ) ) *
                   FILTER_OFFSET_22;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 23.0 * pixelSize ) ) *
                   FILTER_OFFSET_23;
    finalColour += texture2D( u_texture,
                   vec2( v_texCoord.x, v_texCoord.y - 24.0 * pixelSize ) ) *
                   FILTER_OFFSET_24;
